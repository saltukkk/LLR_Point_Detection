...
def process_left_leg(img, segs, img_size=(1024, 256), thresh=0.5, fill_holes=True, num_largest_areas=2):
    """
...
def get_img_and_masks_left(file_path):
...
if __name__ == "__main__":
   ...
   #  print_image_matrix(file_path)
    ...
    img, masks = get_img_and_masks_left(file_path)
    femur_mask, tibia_mask = process_left_leg(img, masks)
